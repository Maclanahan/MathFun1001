    ...
    public class Tutorial : IProblemType
    {
        ...
        public Tutorial() 
        {
            ...
            this.example = new String[] {"<p style=\\\"color:blue\\\">(2x<sup>2</sup>y</p> <p style=\\\"color:red\\\">-3xy)</p> <p>+</p> <p style=\\\"color:blue\\\">(6x<sup>2</sup>y</p><p>-</p><p style=\\\"color:red\\\">9xy)</p>", 
                                        "<p style=\\\"color:blue\\\">(2x<sup>2</sup>y+<answer>6</answer>x<sup>2</sup>y)</p> <p>+</p> <p style=\\\"color:red\\\">(-3xy-9xy)</p>",
                                        "<p style=\\\"color:blue\\\">(8x<sup>2</sup>y)</p> <p>+</p> <p style=\\\"color:red\\\">(<answer>-12</answer>xy)</p>", 
                                        "<p style=\\\"color:blue\\\">8x<sup>2</sup>y</p> <p><answer>-</answer></p> <p style=\\\"color:red\\\">12xy</p>", 
